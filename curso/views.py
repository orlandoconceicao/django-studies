...
class AvaliacaoAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        if self.kwargs.get('curso_pk'):
            return get_object_or_404(self.queryset(), curso_id=self.kwargs.get('curso_pk'), pk=self.kwargs.get('avaliacao.pk'))
        return get_object_or_404(self.queryset(), pk=self.kwargs.get('avaliacao.pk'))
